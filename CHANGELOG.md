...
## 1.3.0 - 2018-04-19
### Added
- Support for retry on OCI service APIs. Example can be found on [Github](https://github.com/erikcai/oci-go-sdk/tree/master/example/example_retry_test.go)
...
## 1.2.0 - 2018-04-05
### Added
- Support for Email Delivery Service. Example can be found on [Github](https://github.com/erikcai/oci-go-sdk/tree/master/example/example_email_test.go)
...
- Support for tagging in Core Services and Identity service. Example can be found on [Github](https://github.com/erikcai/oci-go-sdk/tree/master/example/example_tagging_test.go)
