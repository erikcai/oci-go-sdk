...
GEN_TARGETS = identity core objectstorage loadbalancer database audit dns filestorage email resourcemanager keymanagement resourcesearch containerengine monitoring workrequests ons healthchecks cloudevents streaming cache marketplace autoscaling usage announcementsservice waas batch functions budget limits oda datasafe storagegateway dts apigateway ##SPECNAME##
