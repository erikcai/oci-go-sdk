...
GEN_TARGETS = identity core objectstorage loadbalancer database audit dns filestorage email resourcemanager keymanagement resourcesearch containerengine monitoring workrequests ons healthchecks streaming cache marketplace autoscaling usage announcementsservice waas batch functions budget limits oda storagegateway dts apigateway events nosql datacatalog oce datascience publiclogging bds analytics integration kam publicloggingsearch osmanagement ##SPECNAME##
