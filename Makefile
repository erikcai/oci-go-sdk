...
GEN_TARGETS = identity core objectstorage loadbalancer database audit dns filestorage email resourcemanager kms resourcesearch containerengine telemetry workrequests ##SPECNAME##
