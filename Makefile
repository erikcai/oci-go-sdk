...
GEN_TARGETS = identity core objectstorage loadbalancer database audit dns filestorage email resourcemanager keymanagement resourcesearch containerengine telemetry workrequests ons healthchecks cloudevents streaming cache marketplace ##SPECNAME##
