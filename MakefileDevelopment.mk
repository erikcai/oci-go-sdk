...
make list-test to list all integ tests
make test-[name of the package] to integ test a package
make test-all runs all integ tests
make list-autotest to list all autogenerated test targets
make autotest-[name of the package] to run autogenerated tests
make autotest-all runs all autogenerated tests
endef
