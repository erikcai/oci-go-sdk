...
func createFunctionsClientWithProvider(p common.ConfigurationProvider, testConfig TestingConfig) (interface{}, error) {

	client, err := functions.NewFunctionsClientWithConfigurationProvider(p)
...
func TestFunctionsClientCreateApplication(t *testing.T) {
	...
	cc, err := testClient.createClientForOperation("functions", "Functions", "CreateApplication", createFunctionsClientWithProvider)
	assert.NoError(t, err)
	c := cc.(functions.FunctionsClient)
...
// IssueRoutingInfo tag="default" email="serverless_grp@oracle.com" jiraProject="FAAS" opsJiraProject="FAAS"
func TestFunctionsClientCreateFunction(t *testing.T) {
	...
	cc, err := testClient.createClientForOperation("functions", "Functions", "CreateFunction", createFunctionsClientWithProvider)
	assert.NoError(t, err)
	c := cc.(functions.FunctionsClient)
...
// IssueRoutingInfo tag="default" email="serverless_grp@oracle.com" jiraProject="FAAS" opsJiraProject="FAAS"
func TestFunctionsClientCreateTrigger(t *testing.T) {
	...
	cc, err := testClient.createClientForOperation("functions", "Functions", "CreateTrigger", createFunctionsClientWithProvider)
	assert.NoError(t, err)
	c := cc.(functions.FunctionsClient)
...
// IssueRoutingInfo tag="default" email="serverless_grp@oracle.com" jiraProject="FAAS" opsJiraProject="FAAS"
func TestFunctionsClientDeleteApplication(t *testing.T) {
	...
	cc, err := testClient.createClientForOperation("functions", "Functions", "DeleteApplication", createFunctionsClientWithProvider)
	assert.NoError(t, err)
	c := cc.(functions.FunctionsClient)
...
// IssueRoutingInfo tag="default" email="serverless_grp@oracle.com" jiraProject="FAAS" opsJiraProject="FAAS"
func TestFunctionsClientDeleteFunction(t *testing.T) {
	...
	cc, err := testClient.createClientForOperation("functions", "Functions", "DeleteFunction", createFunctionsClientWithProvider)
	assert.NoError(t, err)
	c := cc.(functions.FunctionsClient)
...
// IssueRoutingInfo tag="default" email="serverless_grp@oracle.com" jiraProject="FAAS" opsJiraProject="FAAS"
func TestFunctionsClientDeleteTrigger(t *testing.T) {
	...
	cc, err := testClient.createClientForOperation("functions", "Functions", "DeleteTrigger", createFunctionsClientWithProvider)
	assert.NoError(t, err)
	c := cc.(functions.FunctionsClient)
...
// IssueRoutingInfo tag="default" email="serverless_grp@oracle.com" jiraProject="FAAS" opsJiraProject="FAAS"
func TestFunctionsClientGetApplication(t *testing.T) {
	...
	cc, err := testClient.createClientForOperation("functions", "Functions", "GetApplication", createFunctionsClientWithProvider)
	assert.NoError(t, err)
	c := cc.(functions.FunctionsClient)
...
// IssueRoutingInfo tag="default" email="serverless_grp@oracle.com" jiraProject="FAAS" opsJiraProject="FAAS"
func TestFunctionsClientGetFunction(t *testing.T) {
	...
	cc, err := testClient.createClientForOperation("functions", "Functions", "GetFunction", createFunctionsClientWithProvider)
	assert.NoError(t, err)
	c := cc.(functions.FunctionsClient)
...
// IssueRoutingInfo tag="default" email="serverless_grp@oracle.com" jiraProject="FAAS" opsJiraProject="FAAS"
func TestFunctionsClientGetTrigger(t *testing.T) {
	...
	cc, err := testClient.createClientForOperation("functions", "Functions", "GetTrigger", createFunctionsClientWithProvider)
	assert.NoError(t, err)
	c := cc.(functions.FunctionsClient)
...
// IssueRoutingInfo tag="default" email="serverless_grp@oracle.com" jiraProject="FAAS" opsJiraProject="FAAS"
func TestFunctionsClientInvokeFunction(t *testing.T) {
	...
	cc, err := testClient.createClientForOperation("functions", "Functions", "InvokeFunction", createFunctionsClientWithProvider)
	assert.NoError(t, err)
	c := cc.(functions.FunctionsClient)
...
// IssueRoutingInfo tag="default" email="serverless_grp@oracle.com" jiraProject="FAAS" opsJiraProject="FAAS"
func TestFunctionsClientListApplications(t *testing.T) {
	...
	cc, err := testClient.createClientForOperation("functions", "Functions", "ListApplications", createFunctionsClientWithProvider)
	assert.NoError(t, err)
	c := cc.(functions.FunctionsClient)
...
// IssueRoutingInfo tag="default" email="serverless_grp@oracle.com" jiraProject="FAAS" opsJiraProject="FAAS"
func TestFunctionsClientListFunctions(t *testing.T) {
	...
	cc, err := testClient.createClientForOperation("functions", "Functions", "ListFunctions", createFunctionsClientWithProvider)
	assert.NoError(t, err)
	c := cc.(functions.FunctionsClient)
...
// IssueRoutingInfo tag="default" email="serverless_grp@oracle.com" jiraProject="FAAS" opsJiraProject="FAAS"
func TestFunctionsClientListTriggers(t *testing.T) {
	...
	cc, err := testClient.createClientForOperation("functions", "Functions", "ListTriggers", createFunctionsClientWithProvider)
	assert.NoError(t, err)
	c := cc.(functions.FunctionsClient)
...
// IssueRoutingInfo tag="default" email="serverless_grp@oracle.com" jiraProject="FAAS" opsJiraProject="FAAS"
func TestFunctionsClientUpdateApplication(t *testing.T) {
	...
	cc, err := testClient.createClientForOperation("functions", "Functions", "UpdateApplication", createFunctionsClientWithProvider)
	assert.NoError(t, err)
	c := cc.(functions.FunctionsClient)
...
// IssueRoutingInfo tag="default" email="serverless_grp@oracle.com" jiraProject="FAAS" opsJiraProject="FAAS"
func TestFunctionsClientUpdateFunction(t *testing.T) {
	...
	cc, err := testClient.createClientForOperation("functions", "Functions", "UpdateFunction", createFunctionsClientWithProvider)
	assert.NoError(t, err)
	c := cc.(functions.FunctionsClient)
...
// IssueRoutingInfo tag="default" email="serverless_grp@oracle.com" jiraProject="FAAS" opsJiraProject="FAAS"
func TestFunctionsClientUpdateTrigger(t *testing.T) {
	...
	cc, err := testClient.createClientForOperation("functions", "Functions", "UpdateTrigger", createFunctionsClientWithProvider)
	assert.NoError(t, err)
	c := cc.(functions.FunctionsClient)
