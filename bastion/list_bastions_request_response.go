...
func (request ListBastionsRequest) HTTPRequest(method, path string) (http.Request, error) {
...
const (
	...
	ListBastionsSortByDisplayname ListBastionsSortByEnum = "displayName"
)

var mappingListBastionsSortBy = map[string]ListBastionsSortByEnum{
	"timeCreated": ListBastionsSortByTimecreated,
	"displayName": ListBastionsSortByDisplayname,
}
