...
type Bastion struct {
	...
	// Private endpoint compartment OCID present in the customer tenancy
	ClientPrivateEndpointCompartmentId *string `mandatory:"true" json:"clientPrivateEndpointCompartmentId"`
