...
type ListSessionsRequest struct {
	...
	// The OCID of the bastion in which to list resources.
	...
	// The OCID of the session in which to list resources
	SessionId *string `mandatory:"false" contributesTo:"query" name:"sessionId"`

	// The OCID of the target instance in which to list resources.
	TargetInstanceId *string `mandatory:"false" contributesTo:"query" name:"targetInstanceId"`
...
func (request ListSessionsRequest) HTTPRequest(method, path string) (http.Request, error) {
