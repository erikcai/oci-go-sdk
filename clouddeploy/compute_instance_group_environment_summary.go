...
//GetId returns Id
func (m ComputeInstanceGroupEnvironmentSummary) GetId() *string {
	return m.Id
}
...
func (m ComputeInstanceGroupEnvironmentSummary) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

//GetTimeUpdated returns TimeUpdated
func (m ComputeInstanceGroupEnvironmentSummary) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

//GetLifecycleState returns LifecycleState
func (m ComputeInstanceGroupEnvironmentSummary) GetLifecycleState() EnvironmentLifecycleStateEnum {
...
func (m ComputeInstanceGroupEnvironmentSummary) String() string {
	return common.PointerString(m)
}

// MarshalJSON marshals to json representation
func (m ComputeInstanceGroupEnvironmentSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeComputeInstanceGroupEnvironmentSummary ComputeInstanceGroupEnvironmentSummary
	s := struct {
		DiscriminatorParam string `json:"environmentType"`
		MarshalTypeComputeInstanceGroupEnvironmentSummary
	}{
		"COMPUTE_INSTANCE_GROUP",
		(MarshalTypeComputeInstanceGroupEnvironmentSummary)(m),
	}
