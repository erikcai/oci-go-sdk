...
func (m ComputeInstanceGroupRollingDeploymentStageExecutionProgress) GetTimeStarted() *common.SDKTime {
	return m.TimeStarted
}

//GetTimeFinished returns TimeFinished
func (m ComputeInstanceGroupRollingDeploymentStageExecutionProgress) GetTimeFinished() *common.SDKTime {
	return m.TimeFinished
}

//GetStatus returns Status
func (m ComputeInstanceGroupRollingDeploymentStageExecutionProgress) GetStatus() StageExecutionProgressStatusEnum {
	return m.Status
}

//GetStatusMessages returns StatusMessages
func (m ComputeInstanceGroupRollingDeploymentStageExecutionProgress) GetStatusMessages() []string {
	return m.StatusMessages
}

func (m ComputeInstanceGroupRollingDeploymentStageExecutionProgress) String() string {
	return common.PointerString(m)
}

// MarshalJSON marshals to json representation
func (m ComputeInstanceGroupRollingDeploymentStageExecutionProgress) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeComputeInstanceGroupRollingDeploymentStageExecutionProgress ComputeInstanceGroupRollingDeploymentStageExecutionProgress
	s := struct {
		DiscriminatorParam string `json:"stageType"`
		MarshalTypeComputeInstanceGroupRollingDeploymentStageExecutionProgress
	}{
		"COMPUTE_INSTANCE_GROUP_ROLLING_DEPLOYMENT",
		(MarshalTypeComputeInstanceGroupRollingDeploymentStageExecutionProgress)(m),
	}
