...
func (m CreateFunctionEnvironmentDetails) String() string {
	return common.PointerString(m)
}

// MarshalJSON marshals to json representation
func (m CreateFunctionEnvironmentDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateFunctionEnvironmentDetails CreateFunctionEnvironmentDetails
	s := struct {
		DiscriminatorParam string `json:"environmentType"`
		MarshalTypeCreateFunctionEnvironmentDetails
	}{
		"FUNCTION",
		(MarshalTypeCreateFunctionEnvironmentDetails)(m),
	}
