...
func (m CreateInvokeFunctionStageDetails) String() string {
	return common.PointerString(m)
}

// MarshalJSON marshals to json representation
func (m CreateInvokeFunctionStageDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateInvokeFunctionStageDetails CreateInvokeFunctionStageDetails
	s := struct {
		DiscriminatorParam string `json:"stageType"`
		MarshalTypeCreateInvokeFunctionStageDetails
	}{
		"INVOKE_FUNCTION",
		(MarshalTypeCreateInvokeFunctionStageDetails)(m),
	}
