...
func (m CreateOkeClusterEnvironmentDetails) String() string {
	return common.PointerString(m)
}

// MarshalJSON marshals to json representation
func (m CreateOkeClusterEnvironmentDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateOkeClusterEnvironmentDetails CreateOkeClusterEnvironmentDetails
	s := struct {
		DiscriminatorParam string `json:"environmentType"`
		MarshalTypeCreateOkeClusterEnvironmentDetails
	}{
		"OKE_CLUSTER",
		(MarshalTypeCreateOkeClusterEnvironmentDetails)(m),
	}
