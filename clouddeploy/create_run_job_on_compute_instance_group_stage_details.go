...
func (m CreateRunJobOnComputeInstanceGroupStageDetails) GetDisplayName() *string {
	return m.DisplayName
}

//GetPipelineId returns PipelineId
func (m CreateRunJobOnComputeInstanceGroupStageDetails) GetPipelineId() *string {
	return m.PipelineId
}
...
func (m CreateRunJobOnComputeInstanceGroupStageDetails) GetStagePredecessorCollection() *StagePredecessorCollection {
	return m.StagePredecessorCollection
}

//GetFreeformTags returns FreeformTags
func (m CreateRunJobOnComputeInstanceGroupStageDetails) GetFreeformTags() map[string]string {
...
func (m CreateRunJobOnComputeInstanceGroupStageDetails) String() string {
	return common.PointerString(m)
}

// MarshalJSON marshals to json representation
func (m CreateRunJobOnComputeInstanceGroupStageDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateRunJobOnComputeInstanceGroupStageDetails CreateRunJobOnComputeInstanceGroupStageDetails
	s := struct {
		DiscriminatorParam string `json:"stageType"`
		MarshalTypeCreateRunJobOnComputeInstanceGroupStageDetails
	}{
		"RUN_JOB_ON_COMPUTE_INSTANCE_GROUP",
		(MarshalTypeCreateRunJobOnComputeInstanceGroupStageDetails)(m),
	}
