...
//GetId returns Id
func (m InvokeFunctionStageSummary) GetId() *string {
	return m.Id
}
...
func (m InvokeFunctionStageSummary) GetLifecycleState() StageLifecycleStateEnum {
...
func (m InvokeFunctionStageSummary) String() string {
	return common.PointerString(m)
}

// MarshalJSON marshals to json representation
func (m InvokeFunctionStageSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeInvokeFunctionStageSummary InvokeFunctionStageSummary
	s := struct {
		DiscriminatorParam string `json:"stageType"`
		MarshalTypeInvokeFunctionStageSummary
	}{
		"INVOKE_FUNCTION",
		(MarshalTypeInvokeFunctionStageSummary)(m),
	}
