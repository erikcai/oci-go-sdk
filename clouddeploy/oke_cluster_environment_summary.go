...
//GetId returns Id
func (m OkeClusterEnvironmentSummary) GetId() *string {
	return m.Id
}
...
func (m OkeClusterEnvironmentSummary) GetLifecycleState() EnvironmentLifecycleStateEnum {
...
func (m OkeClusterEnvironmentSummary) String() string {
	return common.PointerString(m)
}

// MarshalJSON marshals to json representation
func (m OkeClusterEnvironmentSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOkeClusterEnvironmentSummary OkeClusterEnvironmentSummary
	s := struct {
		DiscriminatorParam string `json:"environmentType"`
		MarshalTypeOkeClusterEnvironmentSummary
	}{
		"OKE_CLUSTER",
		(MarshalTypeOkeClusterEnvironmentSummary)(m),
	}
