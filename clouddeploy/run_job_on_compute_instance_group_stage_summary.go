...
//GetId returns Id
func (m RunJobOnComputeInstanceGroupStageSummary) GetId() *string {
	return m.Id
}

//GetDisplayName returns DisplayName
func (m RunJobOnComputeInstanceGroupStageSummary) GetDisplayName() *string {
...
func (m RunJobOnComputeInstanceGroupStageSummary) GetPipelineId() *string {
	return m.PipelineId
}
...
func (m RunJobOnComputeInstanceGroupStageSummary) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

//GetTimeUpdated returns TimeUpdated
func (m RunJobOnComputeInstanceGroupStageSummary) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

//GetLifecycleState returns LifecycleState
func (m RunJobOnComputeInstanceGroupStageSummary) GetLifecycleState() StageLifecycleStateEnum {
...
func (m RunJobOnComputeInstanceGroupStageSummary) String() string {
	return common.PointerString(m)
}

// MarshalJSON marshals to json representation
func (m RunJobOnComputeInstanceGroupStageSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeRunJobOnComputeInstanceGroupStageSummary RunJobOnComputeInstanceGroupStageSummary
	s := struct {
		DiscriminatorParam string `json:"stageType"`
		MarshalTypeRunJobOnComputeInstanceGroupStageSummary
	}{
		"RUN_JOB_ON_COMPUTE_INSTANCE_GROUP",
		(MarshalTypeRunJobOnComputeInstanceGroupStageSummary)(m),
	}
