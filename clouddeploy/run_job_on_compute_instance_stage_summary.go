...
//GetId returns Id
func (m RunJobOnComputeInstanceStageSummary) GetId() *string {
	return m.Id
}
...
func (m RunJobOnComputeInstanceStageSummary) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

//GetTimeUpdated returns TimeUpdated
func (m RunJobOnComputeInstanceStageSummary) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

//GetLifecycleState returns LifecycleState
func (m RunJobOnComputeInstanceStageSummary) GetLifecycleState() StageLifecycleStateEnum {
...
func (m RunJobOnComputeInstanceStageSummary) String() string {
	return common.PointerString(m)
}

// MarshalJSON marshals to json representation
func (m RunJobOnComputeInstanceStageSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeRunJobOnComputeInstanceStageSummary RunJobOnComputeInstanceStageSummary
	s := struct {
		DiscriminatorParam string `json:"stageType"`
		MarshalTypeRunJobOnComputeInstanceStageSummary
	}{
		"RUN_JOB_ON_COMPUTE_INSTANCE",
		(MarshalTypeRunJobOnComputeInstanceStageSummary)(m),
	}
