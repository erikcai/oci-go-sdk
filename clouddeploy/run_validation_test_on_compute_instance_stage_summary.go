...
//GetId returns Id
func (m RunValidationTestOnComputeInstanceStageSummary) GetId() *string {
	return m.Id
}

//GetDisplayName returns DisplayName
func (m RunValidationTestOnComputeInstanceStageSummary) GetDisplayName() *string {
	return m.DisplayName
}

//GetApplicationId returns ApplicationId
func (m RunValidationTestOnComputeInstanceStageSummary) GetApplicationId() *string {
	return m.ApplicationId
}

//GetPipelineId returns PipelineId
func (m RunValidationTestOnComputeInstanceStageSummary) GetPipelineId() *string {
	return m.PipelineId
}

//GetCompartmentId returns CompartmentId
func (m RunValidationTestOnComputeInstanceStageSummary) GetCompartmentId() *string {
	return m.CompartmentId
}

//GetTimeCreated returns TimeCreated
func (m RunValidationTestOnComputeInstanceStageSummary) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

//GetTimeUpdated returns TimeUpdated
func (m RunValidationTestOnComputeInstanceStageSummary) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

//GetLifecycleState returns LifecycleState
func (m RunValidationTestOnComputeInstanceStageSummary) GetLifecycleState() StageLifecycleStateEnum {
...
func (m RunValidationTestOnComputeInstanceStageSummary) GetStagePredecessorCollection() *StagePredecessorCollection {
	return m.StagePredecessorCollection
}

//GetFreeformTags returns FreeformTags
func (m RunValidationTestOnComputeInstanceStageSummary) GetFreeformTags() map[string]string {
...
func (m RunValidationTestOnComputeInstanceStageSummary) String() string {
	return common.PointerString(m)
}

// MarshalJSON marshals to json representation
func (m RunValidationTestOnComputeInstanceStageSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeRunValidationTestOnComputeInstanceStageSummary RunValidationTestOnComputeInstanceStageSummary
	s := struct {
		DiscriminatorParam string `json:"stageType"`
		MarshalTypeRunValidationTestOnComputeInstanceStageSummary
	}{
		"RUN_VALIDATION_TEST_ON_COMPUTE_INSTANCE",
		(MarshalTypeRunValidationTestOnComputeInstanceStageSummary)(m),
	}
