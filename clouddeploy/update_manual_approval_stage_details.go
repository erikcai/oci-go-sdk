...
func (m UpdateManualApprovalStageDetails) String() string {
	return common.PointerString(m)
}

// MarshalJSON marshals to json representation
func (m UpdateManualApprovalStageDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateManualApprovalStageDetails UpdateManualApprovalStageDetails
	s := struct {
		DiscriminatorParam string `json:"stageType"`
		MarshalTypeUpdateManualApprovalStageDetails
	}{
		"MANUAL_APPROVAL",
		(MarshalTypeUpdateManualApprovalStageDetails)(m),
	}
