...
// CreateTargetDetectorRecipe The information required to create TargetDetectorRecipe
type CreateTargetDetectorRecipe struct {
...
func (m CreateTargetDetectorRecipe) String() string {
