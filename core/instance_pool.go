...
// Set of constants representing the allowable values for InstancePoolLifecycleState
const (
...
// GetInstancePoolLifecycleStateEnumValues Enumerates the set of values for InstancePoolLifecycleState
