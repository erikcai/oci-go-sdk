...
// RemoveDrgRouteDistributionStatementsDetails Details request to removing statements from a Route Distribution.
type RemoveDrgRouteDistributionStatementsDetails struct {

	// The Oracle-assigned ID of each Route Distribution to be remove.
