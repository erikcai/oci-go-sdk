...
// RouteRule A mapping between a destination IP address range and a virtual device to route matching packets
// to (a target). The destination IP address range can be either:
//   * An actual IP address range in CIDR notation. For example: `192.168.1.0/24`
