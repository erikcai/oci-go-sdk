...
// UpdateDrgRouteDistributionStatementsDetails Details request to updating statements in a Route Distribution.
type UpdateDrgRouteDistributionStatementsDetails struct {

	// The Route Distribution statements to be updated, and the details to be updated.
