...
// UpdateDrgRouteTableDetails Details request to update a DRG Route Table.
type UpdateDrgRouteTableDetails struct {
	...
	// their on-prem networks, the user should set this value to true on the route table to which these attachments
	// import routes.
