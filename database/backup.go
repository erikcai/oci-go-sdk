...
// Set of constants representing the allowable values for BackupDatabaseEdition
const (
...
// GetBackupDatabaseEditionEnumValues Enumerates the set of values for BackupDatabaseEdition
