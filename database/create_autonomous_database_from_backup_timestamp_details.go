...
// CreateAutonomousDatabaseFromBackupTimestampDetails Details to create an Oracle Autonomous Database by cloning from a backup of an existing Autonomous Database based on Timestamp.
type CreateAutonomousDatabaseFromBackupTimestampDetails struct {
	...
	// The timestamp in the past to clone the source database at.
