...
type CreateRefreshableAutonomousDatabaseCloneDetails struct {
	...
	LagTimeInSeconds *int `mandatory:"true" json:"lagTimeInSeconds"`
...
func (m CreateRefreshableAutonomousDatabaseCloneDetails) GetDbAvailabilityType() CreateAutonomousDatabaseBaseDbAvailabilityTypeEnum {
