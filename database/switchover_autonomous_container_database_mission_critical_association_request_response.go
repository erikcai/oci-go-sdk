...
func (request SwitchoverAutonomousContainerDatabaseMissionCriticalAssociationRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request SwitchoverAutonomousContainerDatabaseMissionCriticalAssociationRequest) HTTPRequest(method, path string) (http.Request, error) {
	return common.MakeDefaultHTTPRequestWithTaggedStruct(method, path, request)
}

// RetryPolicy implements the OCIRetryableRequest interface. This retrieves the specified retry policy.
func (request SwitchoverAutonomousContainerDatabaseMissionCriticalAssociationRequest) RetryPolicy() *common.RetryPolicy {
	return request.RequestMetadata.RetryPolicy
}

// SwitchoverAutonomousContainerDatabaseMissionCriticalAssociationResponse wrapper for the SwitchoverAutonomousContainerDatabaseMissionCriticalAssociation operation
type SwitchoverAutonomousContainerDatabaseMissionCriticalAssociationResponse struct {
...
func (response SwitchoverAutonomousContainerDatabaseMissionCriticalAssociationResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response SwitchoverAutonomousContainerDatabaseMissionCriticalAssociationResponse) HTTPResponse() *http.Response {
