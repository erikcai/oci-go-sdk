...
// SparkSubmitSummary A Data Flow SparkSubmit object used in bulk listings.
type SparkSubmitSummary struct {
	...
	// The OCID of a SparkSubmit object.
	...
	LifecycleState RunLifecycleStateEnum `mandatory:"false" json:"lifecycleState,omitempty"`
...
func (m SparkSubmitSummary) String() string {
