...
// DataEntityShape The data entity summary object.
type DataEntityShape struct {
	Details DataEntityDetails `mandatory:"false" json:"details"`

	Summary *MetadataObjectSummary `mandatory:"false" json:"summary"`
}

func (m DataEntityShape) String() string {
	return common.PointerString(m)
}

// UnmarshalJSON unmarshals from json
func (m *DataEntityShape) UnmarshalJSON(data []byte) (e error) {
	model := struct {
