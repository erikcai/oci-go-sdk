...
type UpdateSteeringPolicyDetails struct {
	...
	// create a monitor, please see Managing Health Checks (https://docs.us-phoenix-1.oraclecloud.com/iaas/Content/HealthChecks/Tasks/managinghealthchecks.htm).
	...
	// and code examples, see Traffic Management API Guide (https://docs.us-phoenix-1.oraclecloud.com/iaas/Content/TrafficManagement/Concepts/trafficmanagementapi.htm).
	// **Template Types**
	...
	// locations to route by, see Traffic Management Geographic Locations (https://docs.us-phoenix-1.oraclecloud.com/iaas/Content/TrafficManagement/Reference/trafficmanagementgeo.htm).
	//
