...
// Set of constants representing the allowable values for TagRuleLifecycleState
const (
...
// GetTagRuleLifecycleStateEnumValues Enumerates the set of values for TagRuleLifecycleState
