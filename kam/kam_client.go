	...
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				...
				response = CreateKamReleaseResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
				response = CreateKamReleaseResponse{}
			}
		}
		return
	}
...
func (client KamClient) DeleteKamRelease(ctx context.Context, request DeleteKamReleaseRequest) (response DeleteKamReleaseResponse, err error) {
	...
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				opcRequestId := httpResponse.Header.Get("opc-request-id")
				response = DeleteKamReleaseResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
				response = DeleteKamReleaseResponse{}
			}
		}
		return
	}
...
func (client KamClient) ListKamCharts(ctx context.Context, request ListKamChartsRequest) (response ListKamChartsResponse, err error) {
	...
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				opcRequestId := httpResponse.Header.Get("opc-request-id")
				response = ListKamChartsResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
				response = ListKamChartsResponse{}
			}
		}
		return
	}
...
func (client KamClient) ListKamReleases(ctx context.Context, request ListKamReleasesRequest) (response ListKamReleasesResponse, err error) {
	...
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				opcRequestId := httpResponse.Header.Get("opc-request-id")
				response = ListKamReleasesResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
				response = ListKamReleasesResponse{}
			}
		}
		return
	}
...
func (client KamClient) UpdateKamRelease(ctx context.Context, request UpdateKamReleaseRequest) (response UpdateKamReleaseResponse, err error) {
	...
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				opcRequestId := httpResponse.Header.Get("opc-request-id")
				response = UpdateKamReleaseResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
				response = UpdateKamReleaseResponse{}
			}
		}
		return
	}
