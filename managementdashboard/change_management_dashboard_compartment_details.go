...
// ChangeManagementDashboardCompartmentDetails Details required for changing the compartment of dashboard.
type ChangeManagementDashboardCompartmentDetails struct {

	// Compartment Identifier
	CompartmentId *string `mandatory:"true" json:"compartmentId"`
}

func (m ChangeManagementDashboardCompartmentDetails) String() string {
