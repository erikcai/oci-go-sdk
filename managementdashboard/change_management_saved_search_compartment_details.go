...
// ChangeManagementSavedSearchCompartmentDetails Details required for changing the compartment of saved search.
type ChangeManagementSavedSearchCompartmentDetails struct {

	// Compartment Identifier
	CompartmentId *string `mandatory:"true" json:"compartmentId"`
}

func (m ChangeManagementSavedSearchCompartmentDetails) String() string {
