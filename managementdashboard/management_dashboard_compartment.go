...
// ManagementDashboardCompartment Properties for a dashboard compartment.
type ManagementDashboardCompartment struct {

	// The ocid of the compartment that owns the dashboard.
	CompartmentId *string `mandatory:"true" json:"compartmentId"`
}

func (m ManagementDashboardCompartment) String() string {
