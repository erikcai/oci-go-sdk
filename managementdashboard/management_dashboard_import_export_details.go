...
// ManagementDashboardImportExportDetails Array of dashboards sent to import, or received from export.
type ManagementDashboardImportExportDetails struct {

	// Array of dashboards
	Dashboards []ManagementDashboard `mandatory:"true" json:"dashboards"`
...
func (m ManagementDashboardImportExportDetails) String() string {
