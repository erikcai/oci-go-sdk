...
type RestoreDbSystemRequest struct {
	...
	RestoreFromBackupDetails CloneOrRestoreFromBackupDetails `contributesTo:"body"`
...
func (request RestoreDbSystemRequest) HTTPRequest(method, path string) (http.Request, error) {
