...
type ListObjectVersionsRequest struct {
	...
	// Use this token from the ListObjectVersions response to get the next page of the object versions in the bucket. This token cannot be used with `start` or `startAfter`.
	ContinuationToken *string `mandatory:"false" contributesTo:"query" name:"continuationToken"`
...
type ListObjectVersionsResponse struct {
	...
	// The ListObjectVersions instance
	ListObjectVersions `presentIn:"body"`
