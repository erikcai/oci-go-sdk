...
// If an optional compartmentId query parameter is provided it returns the namespace name of the corresponding tenancy, provided the user has access to it.
