...
type CreateOperatorControlDetails struct {
	...
	// Optional restrictions on the operator users. Current list of restrictions include nationality and residence.
	// Only operators who satisfy the restrictions can raise an access request associated with a resource governed by this operator control.
