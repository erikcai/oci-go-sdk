...
func (client AccessRequestsClient) approveAccessRequest(ctx context.Context, request common.OCIRequest) (common.OCIResponse, error) {
	httpRequest, err := request.HTTPRequest(http.MethodPost, "/accessRequests/{accessRequestId}/action/approve")
	if err != nil {
		return nil, err
	}
...
func (client AccessRequestsClient) getAccessRequest(ctx context.Context, request common.OCIRequest) (common.OCIResponse, error) {
	httpRequest, err := request.HTTPRequest(http.MethodGet, "/accessRequests/{accessRequestId}")
	if err != nil {
		return nil, err
	}
...
func (client AccessRequestsClient) listAccessRequestHistories(ctx context.Context, request common.OCIRequest) (common.OCIResponse, error) {
	httpRequest, err := request.HTTPRequest(http.MethodGet, "/accessRequests/{accessRequestId}/history")
	if err != nil {
		return nil, err
	}
...
func (client AccessRequestsClient) listAccessRequests(ctx context.Context, request common.OCIRequest) (common.OCIResponse, error) {
	httpRequest, err := request.HTTPRequest(http.MethodGet, "/accessRequests")
	if err != nil {
		return nil, err
	}
...
func (client AccessRequestsClient) rejectAccessRequest(ctx context.Context, request common.OCIRequest) (common.OCIResponse, error) {
	httpRequest, err := request.HTTPRequest(http.MethodPost, "/accessRequests/{accessRequestId}/action/reject")
	if err != nil {
		return nil, err
	}
...
func (client AccessRequestsClient) revokeAccessRequest(ctx context.Context, request common.OCIRequest) (common.OCIResponse, error) {
	httpRequest, err := request.HTTPRequest(http.MethodPost, "/accessRequests/{accessRequestId}/action/revoke")
	if err != nil {
		return nil, err
	}
