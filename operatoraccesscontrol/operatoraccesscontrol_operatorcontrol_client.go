...
func (client OperatorControlClient) changeOperatorControlCompartment(ctx context.Context, request common.OCIRequest) (common.OCIResponse, error) {
	httpRequest, err := request.HTTPRequest(http.MethodPost, "/operatorControls/{operatorControlId}/actions/changeCompartment")
	if err != nil {
		return nil, err
	}
...
func (client OperatorControlClient) createOperatorControl(ctx context.Context, request common.OCIRequest) (common.OCIResponse, error) {
	httpRequest, err := request.HTTPRequest(http.MethodPost, "/operatorControls")
	if err != nil {
		return nil, err
	}
...
func (client OperatorControlClient) deleteOperatorControl(ctx context.Context, request common.OCIRequest) (common.OCIResponse, error) {
	httpRequest, err := request.HTTPRequest(http.MethodDelete, "/operatorControls/{operatorControlId}")
	if err != nil {
		return nil, err
	}
...
func (client OperatorControlClient) getOperatorControl(ctx context.Context, request common.OCIRequest) (common.OCIResponse, error) {
	httpRequest, err := request.HTTPRequest(http.MethodGet, "/operatorControls/{operatorControlId}")
	if err != nil {
		return nil, err
	}
...
func (client OperatorControlClient) listOperatorControls(ctx context.Context, request common.OCIRequest) (common.OCIResponse, error) {
	httpRequest, err := request.HTTPRequest(http.MethodGet, "/operatorControls")
	if err != nil {
		return nil, err
	}
...
func (client OperatorControlClient) updateOperatorControl(ctx context.Context, request common.OCIRequest) (common.OCIResponse, error) {
	httpRequest, err := request.HTTPRequest(http.MethodPut, "/operatorControls/{operatorControlId}")
	if err != nil {
		return nil, err
	}
