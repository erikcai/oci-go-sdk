...
// RecommendationSummary The metadata specific to the recommendation summary.
type RecommendationSummary struct {
	...
	// For example `The status of the recommendation has changed from pending to current(ignored) on this date.`
