	...
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				...
				response = CancelCloudSyncResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
				response = CancelCloudSyncResponse{}
			}
		}
		return
	}
...
func (client StorageGatewayClient) ChangeStorageGatewayCompartment(ctx context.Context, request ChangeStorageGatewayCompartmentRequest) (response ChangeStorageGatewayCompartmentResponse, err error) {
	...
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				opcRequestId := httpResponse.Header.Get("opc-request-id")
				response = ChangeStorageGatewayCompartmentResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
				response = ChangeStorageGatewayCompartmentResponse{}
			}
		}
		return
	}
...
func (client StorageGatewayClient) CreateStorageGateway(ctx context.Context, request CreateStorageGatewayRequest) (response CreateStorageGatewayResponse, err error) {
	...
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				opcRequestId := httpResponse.Header.Get("opc-request-id")
				response = CreateStorageGatewayResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
...
func (client StorageGatewayClient) DisconnectFileSystem(ctx context.Context, request DisconnectFileSystemRequest) (response DisconnectFileSystemResponse, err error) {
	...
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				opcRequestId := httpResponse.Header.Get("opc-request-id")
				response = DisconnectFileSystemResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
				response = DisconnectFileSystemResponse{}
			}
		}
		return
	}
...
func (client StorageGatewayClient) GetCloudSync(ctx context.Context, request GetCloudSyncRequest) (response GetCloudSyncResponse, err error) {
	...
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				opcRequestId := httpResponse.Header.Get("opc-request-id")
				response = GetCloudSyncResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
...
func (client StorageGatewayClient) GetCloudSyncHealth(ctx context.Context, request GetCloudSyncHealthRequest) (response GetCloudSyncHealthResponse, err error) {
	...
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				opcRequestId := httpResponse.Header.Get("opc-request-id")
				response = GetCloudSyncHealthResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
				response = GetCloudSyncHealthResponse{}
			}
		}
		return
	}
...
func (client StorageGatewayClient) GetFileSystemHealth(ctx context.Context, request GetFileSystemHealthRequest) (response GetFileSystemHealthResponse, err error) {
	...
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				opcRequestId := httpResponse.Header.Get("opc-request-id")
				response = GetFileSystemHealthResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
				response = GetFileSystemHealthResponse{}
			}
		}
		return
	}
...
func (client StorageGatewayClient) GetStorageGateway(ctx context.Context, request GetStorageGatewayRequest) (response GetStorageGatewayResponse, err error) {
	...
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				opcRequestId := httpResponse.Header.Get("opc-request-id")
				response = GetStorageGatewayResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
				response = GetStorageGatewayResponse{}
			}
		}
		return
	}
...
func (client StorageGatewayClient) GetStorageGatewayHealth(ctx context.Context, request GetStorageGatewayHealthRequest) (response GetStorageGatewayHealthResponse, err error) {
	...
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				opcRequestId := httpResponse.Header.Get("opc-request-id")
				response = GetStorageGatewayHealthResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
				response = GetStorageGatewayHealthResponse{}
			}
		}
		return
	}
...
func (client StorageGatewayClient) RefreshFileSystem(ctx context.Context, request RefreshFileSystemRequest) (response RefreshFileSystemResponse, err error) {
	...
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				opcRequestId := httpResponse.Header.Get("opc-request-id")
				response = RefreshFileSystemResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
				response = RefreshFileSystemResponse{}
			}
		}
		return
	}
...
func (client StorageGatewayClient) RunCloudSync(ctx context.Context, request RunCloudSyncRequest) (response RunCloudSyncResponse, err error) {
	...
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				opcRequestId := httpResponse.Header.Get("opc-request-id")
				response = RunCloudSyncResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
				response = RunCloudSyncResponse{}
			}
		}
		return
	}
...
func (client StorageGatewayClient) UpdateCloudSync(ctx context.Context, request UpdateCloudSyncRequest) (response UpdateCloudSyncResponse, err error) {
	...
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				opcRequestId := httpResponse.Header.Get("opc-request-id")
				response = UpdateCloudSyncResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
				response = UpdateCloudSyncResponse{}
			}
		}
		return
	}
...
func (client StorageGatewayClient) UpdateStorageGateway(ctx context.Context, request UpdateStorageGatewayRequest) (response UpdateStorageGatewayResponse, err error) {
	...
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				opcRequestId := httpResponse.Header.Get("opc-request-id")
				response = UpdateStorageGatewayResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
				response = UpdateStorageGatewayResponse{}
			}
		}
		return
	}
