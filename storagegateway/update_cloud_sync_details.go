...
// UpdateCloudSyncDetails Details to set when updating the cloud sync.
type UpdateCloudSyncDetails struct {

	// A non-unique, changeable description to update the cloud sync with.
	Description *string `mandatory:"false" json:"description"`

	// Set to true if cloud sync needs to automatically delete files from the target when files
	// are deleted from the source or source files have been renamed.
