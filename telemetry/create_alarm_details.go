...
type CreateAlarmDetails struct {
	...
	// represent true. The query must specify a metric, statistic, interval, and
	// comparison operator (unless defining a query for an absence alarm). Supported values for
